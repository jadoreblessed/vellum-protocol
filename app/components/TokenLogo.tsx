...
export default function TokenLogo({ symbol, color = "#dfe9df" }: TokenLogoProps) {
  ...
  const logos: Record<string, string> = { "$CASHCAT": "/tokens/cashcat.png", "$PONS": "https://coinbazooka.com/storage/logos/coin-b656c4cb-6694-4192-a0b0-eabcd7f34641.webp", "$IF": "https://dd.dexscreener.com/ds-data/tokens/robinhood/0x232cdfc415d10b673845d83dc02ba2eabe7e30d1.png" };
