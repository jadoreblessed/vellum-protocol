...
export default function VellumExperience() {
  ...
  return <main className={s.experience} ref={root}>
    ...
    <footer className={s.footer}><div className={s.footerScene}><Image src="/brand/vellum-sky-hero.webp" alt="" fill sizes="100vw" /><div className={s.footerShade}/><div className={s.footerColumns}><nav aria-label="Footer"><span>MENU</span><a href="#hero-title">Home</a><Link href="/docs">Docs</Link><a href="#how">How it works</a><Link href="/app">Open app</Link></nav><nav aria-label="Social links"><span>SOCIAL</span><a href="https://x.com/VellumRH" target="_blank" rel="noreferrer">Twitter / X</a></nav></div><div className={s.footerCornerMark}><Image src="/brand/vellum-mark.webp" alt="Vellum" fill sizes="72px" /></div><div className={s.footerMarquee} aria-label="Vellum"><div><span>VELLUM®</span><span>VELLUM®</span><span>VELLUM®</span></div></div></div></footer>
  </main>;
}
