...
export default function Home() {
  return <main>
    ...
    <section className="maturity-scene"><div className="container maturity-inner"><div><div className="eyebrow mono">04 / MATURITY</div><h2 className="section-title">Locked now.<em>Claimable later.</em></h2><p className="section-intro">The clock is part of the instrument. It can move, but it cannot be rewritten.</p></div><div className="countdown-art"><div className="countdown-number">90</div><div className="mono">DAYS REMAINING</div><div className="countdown-line"><span /><b>06 AUG 2026</b><b>04 NOV 2026</b></div></div></div></section>
    <section id="protocol" className="section container"><div className="protocol"><div><div className="eyebrow mono">05 / PROTOCOL</div><h2 className="section-title">No owner.<em>No pause.</em></h2><p className="section-intro">The contract is the custodian. Three public functions make the lifecycle legible and verifiable.</p></div><div className="protocol-list">{[["wrap(token, amount, term)","Deposit, price and mint one note."],["transfer(noteId)","Move the claim without selling the position."],["unwrap(noteId)","Burn the note and release the underlying tokens."]].map(([a,b])=><div className="protocol-row" key={a}><b>{a}</b><span>{b}</span></div>)}</div></div></section>
