...
export default function Home() {
  return <main>
    ...
    <ScrollReveal><section className="maturity-scene"><div className="container maturity-inner"><div><div className="eyebrow mono">05 / MATURITY</div><h2 className="section-title">Locked now.<em>Claimable later.</em></h2><p className="section-intro">The clock is part of the instrument. It can move, but it cannot be rewritten.</p></div><div className="countdown-art"><div className="countdown-number"><LiveCounter target={90} /></div><div className="mono">DAYS REMAINING</div><div className="countdown-line"><span /><b>06 AUG 2026</b><b>04 NOV 2026</b></div></div></div></section></ScrollReveal>
